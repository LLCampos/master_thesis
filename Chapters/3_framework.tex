...
I helped in the organization and presentation of a Workshop on Biomedical Text Mining, in which we experimented with having participants of the Workshop annotating Radiology reports with RadLex terms. This experiment was only exploratory since we do not have any gold-standard and the results were still not thoroughly analyzed. Currently, we are working on another experiment of the same kind, but this time having a gold-standard by experts. The idea will be to compare the crowd annotations with the expert annotations.
