...
NOBLE Coder\footnote{\url{http://noble-tools.dbmi.pitt.edu/}} \citep{Tseytlin2016} is a software for NER using a gazetteer-based approach. The gazetteer is set by the user (it  has to be in UMLS (RRF)\footnote{\url{https://www.ncbi.nlm.nih.gov/books/NBK9685/}}, OWL\footnote{\url{https://www.w3.org/OWL/}} or OBO\footnote{\url{http://www.geneontology.org/faq/what-obo-file-format}} formats or be present in BioPortal\footnote{\url{http://bioportal.bioontology.org/ontologies}}) and NOBLE finds, in an arbitrary text, mentions of terms found in the gazetteer.
