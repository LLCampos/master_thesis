...
Other applications include studying the appropriateness of existing Radiology reports templates, as done by Hong \textit{et al.} \citep{Hong2013}.
...
One example of work for the German language is \citep{Bretschneider}. Having in mind that translating all the entries of an ontology one wants to use would be expensive, the authors propose translating only a subset of the ontology, a subset relevant to the task at hand. They do this semi-automatically with the help of the corpus they wanted to annotate. With this, the authors improved the annotation of German text with RadLex terms.
